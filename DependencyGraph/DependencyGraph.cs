...
public class DependencyGraph
    {
        ...
        /// <summary> Enumerates dependees(s). </summary>
        ...
        /// <summary> Removes all existing ordered pairs of the form (r,s).  Then, for each 
        /// t in newDependees, adds the ordered pair (t,s). </summary>
